  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.buttonContainer}>
        {/* mogmog */}
        <div className={styles.emoji} style={{ top: '12%', left: '50%' }}>😋</div>
        <div
        ...
        {/* tektek */}
        <div className={styles.emoji} style={{ top: '50%', left: '12%' }}>🚶‍♂️</div>
        <div
        ...
        {/* parapara */}
        <div className={styles.emoji} style={{ top: '50%', right: '6%' }}>📚</div>
        <div
        ...
        {/* jiiii */}
        <div className={styles.emoji} style={{ bottom: '3%', left: '50%' }}>👀</div>
        <div
        ...
        >
          ...
          <div className={`${styles.subButtons} ${activeMenu === 'jiiii' ? styles.show : ''}`}>
            ...
            <Link href="/jiiii/music" className={styles.subStar} style={{ 
              '--x': '0px', 
              '--y': '-80px', 
              '--rotate': getRandomRotation() 
            } as React.CSSProperties}>
